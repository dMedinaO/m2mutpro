<?php
  ...
  */
  ...
  $nameDocument = "/var/www/html/MLSTrainingTool/jobs/$job/statisticPerformance_$job.csv";
  $row = 0;

  $matrixResponse = [];
  $header = ['Performance', 'Average', 'StandarDeviation', 'Variance',	'MaxValue', 'MinValue'];
  $dataAdd = 0;
