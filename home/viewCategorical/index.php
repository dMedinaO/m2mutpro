...
<head>
  ...
  <script src="../js/jobs/processViewFrequence.js"></script>
  <script src="../js/jobs/processOptionSelecetdClf.js"></script>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <div class="row">
                    ...
                    <div class="panel panel-bordered panel-primary">
                      ...
                      <div class="panel-heading">
                        <h3 class="panel-title">
                          <h3 class="panel-title">Check imbalance class</h3>
                        </h3>
                      </div>
                      <div class="panel-body">
                        <div id="frequncePlot"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <a id="removeOutliers">
                    <div class="col-lg-4 col-md-4">
                      <div class="panel media middle pad-all">
                          ...
                          <div class="media-body">
                              <p class="mar-no text-semibold text-main">Process imbalance and create job </p>
                          </div>
                      </div>
                    </div>
                  </a>
                  ...
                  <div class="col-sm-4 col-md-4 col-lg-4" id="errorResponse" style="display:none;">
                  ...
                  <div class="col-sm-4 col-md-4 col-lg-4" id="okResponse" style="display:none;">
                    <div class="alert alert-success" role="alert">
                      <p class="messageOK"></p>
                    </div>
                  </div>

                  <div class="col-sm-4 col-md-4 col-lg-4" id="loading" style="display:none;">
                      <div class="panel">
                          <div class="panel-body">
